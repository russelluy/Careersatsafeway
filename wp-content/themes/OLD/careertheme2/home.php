	...
	<div class="mid_bg">
		<div class="mid_box">
			<div class="mid_box_lft">
              ...
              <div class="larree_title">Executive Vice President, Safeway Inc.</div>
							<div class="clear"></div>
						</div> <!-- .larree -->
	    ...
	    <div class="mid_box_rt">
	        ...
	        <div class="midbox_rt_bottom">
						<div class="midbox_rt_bottom_lft">
							<img src="<?php bloginfo('template_directory'); ?>/res/pic_rotate_store.png" border="0" alt="" />
				...
				<div id="midbox_lower">
					...
					<a href="military"><img src="<?php bloginfo('template_directory'); ?>/res/specialbutton3.jpg" border="0" alt="" /></a>
						<img src="<?php bloginfo('template_directory'); ?>/res/recognition.png" border="0" alt="" />
