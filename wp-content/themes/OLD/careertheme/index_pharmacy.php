<?php
/*
Template Name: Template Pharmacy
*/
?>
		...
		<div class="mid_box2">
		        ...
		        <div class="midbox_rt_bottom2">
		            <div class="midbox_rt_bottom_lft2">
		                <div class="lft_nav">
		                    <a href="pharmacy-managers">Pharmacy Managers</a>
		                </div>
		                <div class="lft_nav">
		                    <a href="pharmacists">Pharmacists</a>
		                </div>
		                <div class="lft_nav">
		                    <a href="pharmacy-technicians">Pharmacy Technicians</a>
		                </div>
		                <div class="lft_nav">
		                    <a href="pharmacy-internships-programs">Internships/Programs</a>
		                </div>
		                <div class="lft_nav">
